...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="fw-bold mb-1">Add Case Study</h1>
                ...
                <form method="POST" action="{{ route('admin.case-studies.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="long_desc" rows="5" class="form-control tinymce-editor" placeholder="Description">{{ old('long_desc') }}</textarea>
                        </div>
                    </div>
